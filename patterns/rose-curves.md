...
- But polar curves $r(\theta)$ can be written $r(2\pi t)C_1(t)$ where $C_1(t)$ represents [uniform circular motion](../building_blocks/circular-motion) with frequency 1 Hz
