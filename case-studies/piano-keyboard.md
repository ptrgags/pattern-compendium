...
- visual [symmetries](../patterns/symmetry.html) of the keyboard layout[^1]
...
- The symmetry operations of the keyboard exactly directly to [musical symmetries](../patterns/musical-symmetries.html)
...
[^1]: Here, I'm imagining the keyboard to be [infinitely long](../patterns/infinite-piano.html) for symmetry in the strict sense. Another possible view is that the keyboard finite, and the symmetry relationships hold everywhere on the keyboard _except at the ends_.

IMG: Diagram of `E(12, 5) and E(12, 7)` compared with the piano keyboard

- [Euclidean Rhythms](../patterns/euclidean-rhythms.html)
...
- Semitones and Frequency
    ...
    - You could theoretically [extend the keyboard forever](../patterns/infinite-piano.html) in both directions.
...
- Isomorphic Keyboards
    ...
    - [Linear Iso Keyboard](../patterns/linear-iso-keyboard.html)
    ...
    - [Rectangular Iso Keyboard](../patterns/rect-iso-piano.html) - A 2D grid of pitches with a fixed step size in each direction 
        - [Bass Fretboards](./bass-fretboard.html) are one such example.
        - [Guitar Fretboards](./guitar-fretboard.html) _almost_ match this pattern.
    - [Hexagaonal Iso Keyboard](../patterns/hex-iso-piano.html) - If you put the notes on a hex grid with some slight modifications, you get an even
- [Ring Keyboard](../patterns/ring-keyboard.html) - If you ignore the octave of notes, they keyboard loops around. You could draw this as a circular ring.
